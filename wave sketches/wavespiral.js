...
function renderWave() {
 ...
 var centerY = height/2;
  ...
  var diameter = random(1, 5); // diameter of each star ellipse
  var degree = random(-360, 360);
  var radius = random(-width/1.2, width/1.2);
    
  var xLoc = centerX + (radius * cos(radians(degree)));
 var y = centerY + (radius * sin(radians(degree)));
 ...
 for (var x = 0; x < yvalues.length; x++) {
  ...
  fill(30,180, 255,100);
  ellipse(x*xspacing+xLoc,y+yvalues[x],diameter,diameter);
